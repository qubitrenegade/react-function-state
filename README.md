...
This repo is based on [this tweet](https://twitter.com/dan_abramov/status/824308413559668744) from [@dan_abramov](https://twitter.com/dan_abramov) as an exploration in how to test in a canonical fashion.

For those coming to this repo without the context of my [reddit post](https://www.reddit.com/r/reactjs/comments/9k4rk1/testing_functions_in_functional_state_changes/): this is my exploration into how to test the functions of the functional state changes, as it doesn't seem to be as simple as presented in the above linked tweet.

### Running:

Not using `pnpm` yet... so for now:
...
```
  sudo hab pkg install core/node --binlink
  sudo hab pkg install core/yarn --binlink
  yarn global add create-react-app
  yarn create react-app function-state
```

You can read more about Habitat on the [Habitat Website](https://www.habitat.sh/) or on my [Blog](https://qubitrenegade.com), but installing node/yarn in your standard fashion and running as described in [###Running] is sufficient.

As of this writing the test's don't pass...
